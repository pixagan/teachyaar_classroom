...
export const StudentClassroomScreen = ({}) => {
                ...
                <Row>
                    ...
                    <Col style={{padding:'10px', margin:'10px', maxHeight:'90vh', overflowY:'scroll'}}>
                        ...
                        {selectedChannel && channelCS && channelCS.classIsLive!=undefined && channelCS.classIsLive==true && (
                            ...
                            <Col style={{padding:'10px'}}>
                                ...
                                <Card style={{border:'None', padding:'10px'}}>
                                    <InputGroup>
                                    <Button className="button_gen" onClick={()=>addCard('Announcements')}>
                                        <Bell color="blue" size={20} />
                                        </Button>
                                        <Button className="button_gen" onClick={()=>addCard('Notes')}>
                                            <Notebook color="blue" size={20} />
                                        </Button>
                                        <Button className="button_gen" onClick={()=>addCard('Exams')}>
                        ...
                        {tycards && tycards.map((card) => (
                            ...
                            <Fragment>
                                <TYCard card={card} channel_id={selectedChannel} qandaboard_id={selectedChannelQandaBoard} updateToggleInteraction={updateToggleInteraction} usermode='student'/>
                                <br />
                            </Fragment>
