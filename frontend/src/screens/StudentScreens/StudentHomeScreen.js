...
import { Camera, Newspaper, NotebookPen, ClipboardList, Contact } from 'lucide-react';
...
export const StudentDashboardScreen = ({}) => {
    ...
    return (
        ...
        <div style={{padding:'10px', margin:'20px', minHeight:'98vh'}}>
                ...
                {/* <InputGroup>
                    <Button className='button_gen'>Classes</Button>
                            ...
                            <Fragment>
                                ...
                                <Card className="card_channel">
                                    ...
                                    <Row>
                                        ...
                                        <Link to={`/teacher/tests/${channel._id}`}>
                                        <Button className="button_gen">
